    ...
    public function run()
    {
        ...
        $projects = [
            ...
            ['judul' => 'Airline Delay Cause Analysis', 
             ...
             'desc' => 'Analisis ini menyajikan visualisasi komprehensif tentang keterlambatan penerbangan di seluruh Amerika Serikat, pada Januari 2017 sampai Juli 2022, dengan fokus pada pola dan tren keterlambatan berdasarkan maskapai, bandara dan berbagai penyebab keterlambatan. Untuk Data Cleaning dilakukan dengan Python dan  Pembuatan Dashboard visualisasi menggunakan aplikasi Tabelau untuk dapat mengeksplorasi faktor-faktor penyebab keterlambatan, seperti cuaca, masalah teknis, atau lalu lintas udara, serta membandingkan performa antar maskapai dan bandara. Hasil analisis ini memberikan wawasan yang berguna untuk pengambilan keputusan dalam meningkatkan efisiensi operasional dan kepuasan pelanggan di industri penerbangan. Untuk melihat proses data cleaning menggunakan Python silahkan kunjungi Notebook Analysis di bawah Dashboard.'],
            ...
            ['judul' => 'E-Commerce Customer Analysis', 
             ...
             'desc' => 'E-Commerce Customer Analysis ini bertujuan untuk mengeksplorasi dan memahami pelanggan e-commerce. Proses Data Ceaning dilakukan menggunakan Python di Google Colab, selanjutnya melakukan analisis untuk mengidentifikasi pola, tren dan segmen pelanggan yang paling menguntungkan, frekuensi pembelian, dan nilai rata-rata pesanan. Visualisasi menggunakan Google Looker Studio untuk menggambarkan distribusi pelanggan berdasarkan umur, lokasi, dan aktivitas pembelian. Tujuannya adalah untuk memberikan wawasan yang mendalam tentang karakteristik pelanggan e-commerce dan membantu strategi pemasaran dan penjualan yang lebih efektif.'],
            ...
            ['judul' => 'Car Efficientest Analytics', 
             ...
             'desc' => 'Analisis Car Efficientest Analysis ini bertujuan untuk mengevaluasi efisiensi bahan bakar, dimana mobil yang efisien di asumsikan memiliki konsumsi bahan bakar yang rendah dan memiliki engine size yang besar, identifikasi efisiensi mobil divisualisasikan menggunakan aplikasi Tableau berdasarkan merek, model, kelas kendaraan, dan tipe transmisi. Tujuannya adalah untuk mempermudah konsumen dalam menentukan pilihan mereka berdasarkan efisiensi bahan bakar. Analisis dimulai dengan pembersihan data menggunakan, termasuk penanganan nilai yang hilang dan memastikan tipe data yang sesuai menggunakan Python. Pengukuran efisiensi dilakukan dengan membagi engine size dengan konsumsi bahan bakar untuk menghasilkan nilai efisiensi. Selanjutnya, data divisualisasikan berdasarkan setiap kolom dan diurutkan berdasarkan mobil yang paling efisien dalam penggunaan bahan bakar. Untuk melihat proses data cleaning dan perhitungan efisiensi menggunakan Python silahkan kunjungi Notebook Analysis di bawah Dashboard.'],
