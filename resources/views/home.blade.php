<x-layout>
        ...
        <div class="parallax"> 
          <div class="row mt-5 d-flex flex-column flex-md-row align-items-center text-center text-md-start">
            <div class="row mt-5 justify-content-enter align-items-center">
                ...
                <img class="img-fluid rounded-circle w-90 w-lg-50 d-block mx-auto mx-lg-auto" src="images/Ahmad/ahmad-formal-almet-nobg.png" alt="me" style="margin-left: auto; margin-right: auto;">
                </div>
              <div class="col-12 col-lg-6 text-dark text-center text-lg-start">
                <h2 class="display-5 pt-md-5 mt-md-5 pt-5 font-monospace text-secondary">
                  <span id="typed-text"></span>Hi There 👋, I'am <span class="cursor"></span>
                </h2>
                <h1 class="display-6 fw-bold text-judul">Sayid Muhammad Jundullah</h1>
                <p class="fs-4 fw-light">
                  <span id="typed-role"></span><span class="cursor-role">|</span>
                </p>
    ...
    <!-- Working Experiences -->
      <section id="about" class="section-hidden" style="margin-top: -3px">
        <div class="container">
          <div class="row text-center mb-3 mt-5">
            <div class="col fw-light">
              ...
              <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                  <div class="card animate">
                      <div class="card-body">
                          ...
                          <p class="card-text fw-lighter text-secondary">{{ $project->category }} | <span class="text-success">{{$project->tech}}</span></p>
                          <a class="text-secondary custom-link" href="/{{ $project->categoryslug }}/{{ $project->slug }}">Details &raquo;</a>                          
                      </div>
                  </div>
              </div>
      ...
      <section id="education" class="section-hidden">
        <div class="container" style="padding-bottom: 10rem">
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-4">
              <div class="mx-auto animate mb-3" style="width: 18rem;">
              <img src="images/Education/{{ $education->name }}" class="card-img-top" alt="{{ $education->school }}">
                <div class="card-body">
                  <hr>
...
document.addEventListener("DOMContentLoaded", function() {
    const roles = ["Web Developer", "Data Enthusiast"];
    const typedRole = document.getElementById("typed-role");
    const cursorRole = document.querySelector(".cursor-role");
    let roleIndex = 0;
    let charIndex = 0;
    let isErasing = false;
    ...
    function typeRole() {
      if (!isErasing && charIndex < roles[roleIndex].length) {
        ...
        charIndex++;
        setTimeout(typeRole, 150); // Typing speed
      } else if (isErasing && charIndex > 0) {
        typedRole.textContent = roles[roleIndex].substring(0, charIndex - 1);
        charIndex--;
        setTimeout(typeRole, 100); // Erasing speed
      } else {
        isErasing = !isErasing;
        if (!isErasing) {
          roleIndex = (roleIndex + 1) % roles.length;
        }
        setTimeout(typeRole, 1000); // Pause before switching
      }
    }
