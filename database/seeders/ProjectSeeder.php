    ...
    public function run()
    {
        ...
        $projects = [
            ...
            [
                ...
                'tech' => 'Python, Google Looker Studio',
            ...
            [
                'judul' => 'Website Pemesanan Makanan',
                'slug' => 'website-pemesanan-makanan',
                'category' => 'Web Development',
                'categoryslug' => 'web-development',
                ...
                'desc' => 'Website pemesanan makanan untuk RM Simangat dirancang untuk memudahkan pelanggan dalam memesan makanan tanpa perlu antre. Dengan menggunakan teknologi Laravel sebagai backend, Vue.js untuk antarmuka pengguna, dan MySQL sebagai database, pelanggan dapat dengan mudah melakukan pemesanan melalui website. Pesanan yang masuk akan langsung diterima oleh admin RM Simangat untuk segera diproses. Pelanggan dapat memantau status pesanan mereka secara real-time hingga pesanan siap diambil, sehingga proses menjadi lebih efisien dan praktis bagi kedua belah pihak.'
            ],
